...
if (isset($_POST["submit"]) && !empty($_POST["submit"])) {
    $user = mysqli_real_escape_string($call->connect(), $_POST["user"]);
    $password = mysqli_real_escape_string($call->connect(), $_POST["password"]);
    if (!empty($user) && !empty($password)) {
        $msg = $call->user_login($user, $password);
    } else {
...
<!-- Mirrored from ceramax.netlify.app/dashboard/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Sep 2022 03:06:50 GMT -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" name="user" placeholder="email/username">
                                        </div>
                                    </div>
...
<!-- Mirrored from ceramax.netlify.app/dashboard/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Sep 2022 03:06:52 GMT -->
</html>